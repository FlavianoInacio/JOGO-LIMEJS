goog.provide('rpg_tutorial.Button');
 ...
 * @extends lime.Button
 */
rpg_tutorial.Button = function(txt) {
    lime.GlossyButton.call(this, txt);

    this.borderWidth = 4;
    this.setColor('#000');
};
goog.inherits(rpg_tutorial.Button, lime.GlossyButton);
 ...
 */
rpg_tutorial.Button.prototype.makeState_ = function() {
 ...
 */
rpg_tutorial.Button.prototype.setColor = function(clr) {
